    ...
    <div class="col-md-3 col-lg-4 col-sm-12">
        <div class="blockCourseToevoegen">
            ...
            <div class="contentBlockRight">
                ...
                <a href="<?php if(isset($_GET['id'])) echo '/dashboard/teacher/course-selection/?func=add-add-article&id=' . $_GET['id'] . '&step=2&edit'; echo '?func=add-article&message=Please finish this step before'?>" class="contentBlockCourse">
                    <div class="circleIndicator passEtape2">
                        <i class="fa fa-font"></i>
                    </div>
                    <p class="textOpleidRight">Schrijf je artikel</p>
                </a>
                <a href="<?php if(isset($_GET['id'])) echo '/dashboard/teacher/course-selection/?func=add-add-article&id=' . $_GET['id'] . '&step=3&edit'; echo '?func=add-article&message=Please finish this step before'?>" class="contentBlockCourse">
