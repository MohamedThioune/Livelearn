<?php /** Template Name: product training template */ ?>
<?php wp_head(); ?>
<?php get_header(); ?>
        ...
        <div class="container-fluid">
            <div class="overElement">
                <div class="blockOneOver">
                    ...
                    <p class="e-learningTitle">Training Course Test</p>
                    <!-- Image -->
                    <div class="img-fluid-course">
                        <img src="<?php echo get_stylesheet_directory_uri();?>/img/training.jpg" alt="">
                    </div>
