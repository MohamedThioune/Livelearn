...
<div class="content-mandatory">
    <div class="head-mandatory d-flex flex-wrap align-items-center justify-content-between">
        <h1 class="title-mandatory">The fundamental principles of Design TCP/IP network</h1>
        <p class="category">Opleiding</p>
    </div>
                ...
                <div class="detail-checkout-of">
                    ...
                    <div class="content">
                        <div class="block-element-detail">
                            ...
                            <div>
                                <p class="sub-text-1">Shared by :</p>
                        ...
                        <div class="block-element-detail">
                            ...
                            <div>
                                <p class="sub-text-1">Date</p>
                                <p class="sub-text-2">Wed, Jun 01, 2022</p>
                            </div>
                        </div>
                        <div class="block-element-detail">
                            <div class="sub-detail-circle">
