                ...
                <form action="" method="POST">
                    <div class="wrapperClone">
                             ...
                             <div class="modal-dialog" role="document">
                                 <div class="modal-content">
                                     ...
                                     <div class="modal-body">
                                         <div class="dataEnLocation">
                                             <div class="groupInputDate">
                                                 <div class="input-group colM form-group">
                                     ...
                                     <div class="modal-footer">
                                         <button type="reset" data-dismiss="modal" class="btn btn-info">Opslaan & verder</button>
                                     </div>
                                 </div>
                             </div>
                         </div>
                        ...
                        <div class="buttons groupBtnData">
                            <button type="button" class="remove btn btnRemoveElementClone">Remove</button>
                            <button type="button" class="clone btn-newDate"> Complete with another section</button>
