        ...
        <div class="cardOverviewCours">
            <div class="headListeCourse">
                <p class="JouwOpleid"> <!-- Alle opleidingen --> <strong>LOAD FROM</strong> : &nbsp; 
                    <a href="/youtube-v3-playlist" target="_blank" style="text-decoration:none; color: #DD2B26; border: solid #DD2B26; padding: 8px 3px; border-radius: 5px;" class="JouwOpleid">YouTube <img width='30' src="<?= get_stylesheet_directory_uri(); ?>/img/YouTube.jpg" alt="youtube image"></a>
                ...
                <table class="table table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr id="<?= $key ?>" class="<?= $state ?>">
                            ...
                            <td class=""> <input type="button" class="optie btn-default" id="accept" style="background:white; border: DEE2E6" value="✔️" />&nbsp;&nbsp;<input type="button" class="optie btn-default" id="decline" style="background:white" value="❌" />&nbsp;&nbsp; <a class="btn-default" target="_blank"  style="background:white" href="id=<?= $key ?>">⚙️</a> </td>
                        </tr>
                        <?php
                        }
                        ?>
