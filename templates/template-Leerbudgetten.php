<?php /** Template Name: Leerbudgetten */ ?>
    ...
    <div class="theme-side-menu">
        ...
        <section id="sectionDashboard1" class="sidBarDashboard sidBarDashboardIndividual" name="section1">
            <button class="btn btnSidbarMobCroix">
                <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/cancel.png" alt="">
            </button>
            <div class="row">
                <div class="col">
                        ...
                        <ul class="">
                            <li class="elementTextDashboard">
                                ...
                                <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Dashboard.png" >
                                    </div>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            <li class="elementTextDashboard">
                                <a href="/dashboard/company/people-mensen/" class="d-flex">
                                    <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Mijn-mensen.png" >
                                    </div>
                                    <span> Mensen</span>
                                </a>
                            </li>
                            <li class="elementTextDashboard">
                                <a href="/dashboard/company/learning-modules/" class="d-flex">
                                    <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Overzicht_opleidingen.png" >
                                    </div>
                            ...
                            <li class="elementTextDashboard">
                                ...
                                <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Leer-databank.png" >
                                    </div>
                            ...
                            <li class="elementTextDashboard">
                                <a href="#" class="d-flex">
                                    <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Berichten.png" >
                                    </div>
                            ...
                            <li class="elementTextDashboard">
                                <a href="#" class="d-flex">
                                <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Financien.png" >
                                    </div>
                                    <span>Berichten</span>
                                </a>
                            </li>
                            <li class="elementTextDashboard">
                                <a href="#" class="d-flex">
                                    <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Statistieken.png" >
                                    </div>
                            ...
                            <li class="elementTextDashboard">
                                ...
                                <div class="elementImgSidebar" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Instellingen.png" >
                                    </div>
                            ...
                            <li class="elementTextDashboard">
                                ...
                                <div class="elementImgSidebar imgSide2" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Manage-Organisatie.png" >
                                    </div>
                            ...
                            <li class="elementTextDashboard">
                                <a href="#" class="d-flex">
                                <div class="elementImgSidebar imgSide2" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Instroom.png" >
                                    </div>
                                    <span>Instroom</span>
                                </a>
                            </li>
                            <li class="elementTextDashboard">
                                <a href="#" class="d-flex">
                                    <div class="elementImgSidebar imgSide2" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Doorstroom.png" >
                                    </div>
                            ...
                            <li class="elementTextDashboard">
                                <a href="#" class="d-flex">
                                    <div class="elementImgSidebar imgSide2" >
                                        <img src="http://localhost/livelearn/wp-content/themes/fluidify-child/img/Uitstroom.png" >
                                    </div>
                                    <span>Uitstroom</span>
                                </a>
                            </li>
        ...
        <div class="contentPageManager managerOverviewMensen">
            ...
            <div class="bg-white mt-5 p-2 radius-custom mx-4 mx-md-0" id="div_table" style="display:block" >  
                ...
                <div class="d-flex justify-content-between w-100 border-bottom border-5 pb-2">
                    <div class="h5 pt-2"><strong>Buget Livelearn team</strong></div>
                    <div><button class="btn text-white" id="addNew" style="background: #00A89D"><strong>Naar bedrijfsniveau</strong></button></div>   
                </div>
...
<script>
    ...
    // });
    const targetDiv = document.getElementById("div_table");
