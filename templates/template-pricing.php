...
<div class="contentPricing">
    <div class="container">
        ...
        <p class="sousPricing">We hebben de prijzen zo eenvoudig mogelijk proberen te meken: <br> Als individu betaal je niets, als opleider / expert allen voor nieuwe klanten en als organisatie betaal jo voor gebruik </p>
        <div class="row">
            <div class="col-md-4">
