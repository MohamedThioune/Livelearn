...
<body>
     <div class="block-sme mt-90 theme-skills theme-new-element">
         <section>
                 ...
                 <div class="row d-flex justify-content-center my-md-5">
                     <div class="col-md-8 col-10  text-center">
                         <h2 class="wordDeBestText2 fw-bold"  style="color: #023356; max-width: 100%;">
                             <span>Boost je Verkoop:</span> Bereik Nieuwe Klanten en Optimaliseer Succes via ons platform.
                         </h2>
                         <p class="krijgText">
                 ...
                 <div class="row">
                     <div class="col-lg-6">
                         <div class="content-Ontdek">
                             <h2 class="title-section">Het Financiële Voordeel van meer Zichtbaarheid bij Potentiële Klanten</h2>
                             <p class="description-section">Het vergroten van zichtbaarheid bij potentiële klanten biedt aanzienlijke financiële voordelen. Door je bedrijf, producten of diensten meer zichtbaar te maken, vergroot je de kans op het aantrekken van nieuwe klanten en het genereren van meer omzet. Zichtbaarheid stelt je in staat om je merkbekendheid te vergroten, je concurrentiepositie te versterken en klanten aan te trekken die anders mogelijk niet van je bestaan afwisten. Het investeren in zichtbaarheid kan resulteren in een sterkere klantenbasis en een hogere winstgevendheid op lange termijn. </p>
                         </div>
                     </div>
                     <div class="col-lg-6">
                         <div class="block-img-skills">
                             <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/verkopen1.png" class="" alt="">
                         </div>
                     </div>
                 </div>
             </div>
