<?php /** Template Name: overview Podcat */ ?>
    ...
    <section class="boxOne3-1">
        <div class="container">
            <div class="BaangerichteBlock">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-podcast.png" class="img-head-about border-0" alt="">
                <h1 class="wordDeBestText2">All Podcast</h1>
