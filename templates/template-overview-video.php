<?php /** Template Name: overview video */ ?>
    ...
    <section class="boxOne3-1">
        <div class="container">
            <div class="BaangerichteBlock">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon-video.png" class="img-head-about border-0" alt="">
                <h1 class="wordDeBestText2">All Video Course</h1>
                    ...
                    <div class="content-course-block">
                        ...
                        <div class="details-card-course">
                            ...
                            <div class="autor-price-block d-flex justify-content-between align-items-center">
                                ...
                                <div class="blockOpein d-flex align-items-center playlistContent">
                                    <i class="fa fa-play-circle"></i>
                                    <p class="lieuAm">10 Episodes</p>
                                </div>
                            </div>
                        </div>
                    </div>
