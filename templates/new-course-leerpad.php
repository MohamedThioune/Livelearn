           ...
           <div class="block-img">
            ...
            <div class="block-detail-podcast">
                ...
                <div class="d-flex flex-wrap">
                    <div class="d-flex">
                        <div class="block-img-created-assessment">
                            <img src="<?php echo get_stylesheet_directory_uri();?>/img/Daniel-van-der-Kolk.png" alt="">
                        </div>
                        <div class="block-sub-detail">
                            <p class="category-text-title">Created by</p>
                            <p class="category-text">Alison Dawn</p>
                        </div>
                    </div>
                    <div class="block-sub-detail">
                                    ...
                                    <div class="main-accordion">
                                        <ul class="list">
                                            <li>
                                                ...
                                                <div class="list-text">
                                                   <h3 class="name-course">Course A</h3>
                                            ...
                                            <li>
                                                <button class="list-heading"><h2>Event</h2></button>
                                                <div class="list-text">
                                                    <h3 class="name-course">Course A</h3>
                                                    <div class="block-description">
                                                        <p class="text-tabs">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by
