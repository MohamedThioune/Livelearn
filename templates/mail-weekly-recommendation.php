...
<head>
  <title>Hello '. $first_name .', some courses for you this week.</firs-name></title><!--[if !mso]><!-->
                        ...
                        <div
                          ...
                          <h1 class="text-build-content"
                            ...
                            data-testid="RJMLrMvA0Rh"><span
                              style="color:#023356;font-family:Arial;font-size:25px;line-height:35px;"><b>Weekly courses who suit you !</b></span></h1>
                        </div>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <div
                          ...
                          <p class="text-build-content" data-testid="S_MPaSnC0uI"
                            style="margin: 10px 0; margin-bottom: 10px;"><span
                              style="color:#787878;font-family:Arial;font-size:14px;line-height:22px;">Je wekelijkse portie educatieve content.<br>
                              Zo blijf je eenvoudig op de hoogte van de laatste ontwikkelingen. 🚀</span></p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
