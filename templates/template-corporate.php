...
<div class="block-zzpers block-sme theme-new-element corporate-theme">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="content-img-sme">
                        <img src="<?php echo get_stylesheet_directory_uri();?>/img/corporate.png" alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <section class="section-revolutionnaire">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="content-Ontdek">
                            <h2 class="title-section">Leer hoe <span>data en rapportage</span> van skills jouw corporate organisatie transformeren en je concurrenten achterlaten!</h2>
