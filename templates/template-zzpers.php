...
<body>
    ...
    <section class="zzpersSection">
        ...
        <div class="row d-flex justify-content-center blocklogoZppers logo_slider pt-4">
            <div class="mx-1">
    ...
    <div class="container-fluid">
                ...
                <div class="swiper-wrapper">
                    ...
                    foreach($blogs as $course){
                        ...
                        */
                        ...
                        ?>
                        <a href="<?= get_permalink($course->ID) ?>" class="swiper-slide swiperSlideModife">
        ...
        <section class="zzpersSection blockRoadTest">
            <?php
            if(!empty($leerpaden)){
                ?>
        ...
        <section class="py-4 zzpersSection px-3" >
            <div class="row">
    ...
    <section class="py-5 zzpersSection" style="background: #043356">
        <div class="container-fluid">
