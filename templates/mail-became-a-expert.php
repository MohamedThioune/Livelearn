                      ...
                      <td align="left" vertical-align="middle"
                        ...
                        <div
                          ...
                          <p class="text-build-content"
                            ...
                            data-testid="Y0h44Pmw76d">Nieuwe rol, expert</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                      ...
                      <td align="left" vertical-align="middle"
                        ...
                        <div
                          ...
                          <p class="text-build-content" data-testid="S_MPaSnC0uI" style="margin: 10px 0;"><span
                              ...
                              als expert binnen LiveLearn. Dit betekent dat je nu content kan maken, delen of verkopen
                              via je eigen </span><a class="link-build-content"
                              style="color:inherit;; text-decoration: none;" target="_blank"
                              href="https://livelearn.nl/dashboard/teacher/"><span
                                style="color:#787878;font-family:Arial;font-size:14px;line-height:22px;"><u>expert
                                  dashboard</u></span></a><span
                              style="color:#787878;font-family:Arial;font-size:14px;line-height:22px;">.&nbsp;</span>
                          </p>
                          <p class="text-build-content" data-testid="S_MPaSnC0uI" style="margin: 10px 0;"><span
                              style="color:#787878;font-family:Arial;font-size:14px;line-height:22px;">Vergeet je niet
                              aan onze regels te houden en succes om bij de top-experts in jouw vakgebied te
                              behoren.</span></p>
                          <p class="text-build-content" data-testid="S_MPaSnC0uI" style="margin: 10px 0;"><span
                          ...
                          <tbody>
                            <tr>
                              <td align="center" bgcolor="#023356" role="presentation"
                                ...
                                valign="middle"><a href="https://livelearn.nl/dashboard/teacher/"
