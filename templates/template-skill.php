...
<div class="boxOne3-1">
    <div class="container">
        <div class="BaangerichteBlock">
            <p class="wordDeBestText2">Skillgerichte groei</p>
            <p class="altijdText2 paddingElement">Ontwikkelen van specifieke skills die jou beter maken in je huidige werk? Hieronder alle
                skills die jou verder kunnen helpen in je carrière.</p>
        </div>
    </div>
</div>
<div class="groupBtn">
