...
<?php
    ...
    if (isset($ids)) {
        foreach ($ids as $key => $id) {
            ...
            $title = explode(' ',strval(strip_tags($artikels['titel'])));
            $desc = explode(' ',strval(strip_tags($artikels['short_description'])));
            $content=explode(' ',strval(strip_tags($artikels['long_description'])));
            $keyword=array_merge($title,$desc,$content);
