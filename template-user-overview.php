...
<div class="head2" style="margin-top: 1px !important;">
    ...
    <div class="elementText3">
        <p class="liverTilteHead2"><?php echo $name ?><img style="height: 24px;" src="<?php echo $company_logo; ?>" alt=""></p>
        <form action="/dashboard/user/" method="POST">
            ...
            if($user_id != 0 )
            {
                ...
                echo '<img style="height: 30px;" class="rounded-pill" src="<?php echo $logo_livelearn; ?>" alt="">';        
            } 
            ...
            ?>
                ...
                <span class="fw-bold h5" style="color: #023356">Company name</span>
            <?php
                }
            ?>
